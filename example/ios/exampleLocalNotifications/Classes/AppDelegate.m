...
//
//  AppDelegate.m
//  exampleLocalNotifications
//
//  Created by Chris Wynn on 10/30/12.
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"exampleLocalNotifications launchOptions = %@", url);
    }    
...
// only valid if exampleLocalNotifications-Info.plist specifies a protocol to handle
